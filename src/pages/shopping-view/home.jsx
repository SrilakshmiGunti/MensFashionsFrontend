    ...
    return dispatch(
      ...
      if (data?.payload?.success) {
        ...
        toast({
          ...
          isClosable: false, // Set to false to remove the close button
          toastId: `success-${getCurrentProductId}`, // Unique toastId for success
        });
      } else {
        toast({
          title: "Error",
          ...
          duration: 3000, // Show the toast for 3 seconds
          isClosable: false, // Set to false to remove the close button
          toastId: `error-${getCurrentProductId}`, // Unique toastId for error
        });
      }
      return data;
    });
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {categoriesWithIcon.map((categoryItem) => (
              <Card
                key={categoryItem.id} // Add unique key prop
                onClick={() =>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {brandsWithIcon.map((brandItem) => (
              <Card
                key={brandItem.id} // Add unique key prop
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {productList && productList.length > 0
              ? productList.map((productItem) => (
                  <ShoppingProductTile
                    key={productItem._id} // Add unique key prop
